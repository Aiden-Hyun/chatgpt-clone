...
import { createThemeSettingsStyles } from "./ThemesScreen.styles";
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        />
        <Text variant="h2" weight="semibold" style={styles.headerTitle}>
          Theme & Appearance
        </Text>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <Card
            variant="default"
            padding="lg"
            containerStyle={styles.currentThemeCard}
          >
            ...
            {availableThemes.map((themeOption) => {
              ...
              return (
                ...
                >
                  ...
                  <Text variant="body" weight="medium" style={styles.themeName}>
                    {themeOption.name}
                  </Text>
                  {isSelected && (
